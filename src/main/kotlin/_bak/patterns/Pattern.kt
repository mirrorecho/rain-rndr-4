...
//    open fun extend(vararg rain.score.nodes: Node) = warningNotImplemented("extend")
//
//    // deletes rain.score.relationships and potentially intermediary rain.score.nodes (and destination rain.score.nodes if deleteNodes=true)
